...
export const useCustomerStore = defineStore('customer', () => {
  ...
  async function setCustomer(customerName: string) {
    ...
    try {
      ...
      // Fetch addresses, contacts, and cars
      addresses.value = []
      contacts.value = []
      cars.value = []
      ...
      try {
        const [addrData, contactData, carData] = await Promise.all([
          ...
          call('pos_prime.api.customers.get_customer_cars', { customer: customerName }),
        ])
