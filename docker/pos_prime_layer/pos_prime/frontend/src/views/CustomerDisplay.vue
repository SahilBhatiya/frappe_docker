					...
					<div v-else class="max-w-3xl mx-auto p-4 lg:p-6 space-y-5">
						...
						>
							<div class="flex items-start justify-between">
								...
								<a
									...
									target="_blank"
									class="flex items-center gap-1 text-xs text-gray-950 dark:text-gray-100 hover:underline"
								>
									Open in ERPNext
						...
						<div class="grid grid-cols-3 gap-3">
							...
							>
								<FileText
									:size="18"
									class="mx-auto text-gray-700 dark:text-gray-300 mb-1.5"
								/>
								<div class="text-lg font-bold text-gray-900 dark:text-gray-100">
								...
								>
									<div class="flex items-center gap-2 mb-1">
										...
										<span
											...
											class="text-[10px] bg-gray-200 dark:bg-gray-700 text-gray-950 dark:text-gray-100 px-1.5 py-0.5 rounded-full"
											>Primary</span
										>
										<span
										...
										>
											<td class="py-2 pr-3">
												<a
													...
													target="_blank"
													class="text-gray-950 dark:text-gray-100 hover:underline"
												>
													{{ inv.name }}
												</a>
											</td>
