...
<template>
	...
	<div v-else class="h-full">
		...
		>
			<!-- Items panel -->
			<div
				class="flex flex-col overflow-hidden bg-white rounded-2xl min-w-0"
			...
			>
				<div
					class="w-1 h-8 rounded-full bg-gray-200 dark:bg-gray-700 group-hover:bg-gray-950 dark:group-hover:bg-gray-200 group-active:bg-black transition-colors"
				/>
			</div>
		...
		<!-- Mobile tab switcher -->
		<div
			class="sm:hidden fixed bottom-14 left-0 right-0 flex bg-white dark:bg-gray-900 border-t border-gray-200 dark:border-gray-800 z-10"
		>
			<button
				...
				:class="
					mobileTab === 'items'
						? 'text-gray-950 dark:text-gray-100 bg-gray-100 dark:bg-gray-800'
			...
			>
				...
				<span
					...
					class="absolute top-1 right-1/4 bg-gray-950 text-white text-[10px] font-bold rounded-full w-4 h-4 flex items-center justify-center"
				>
