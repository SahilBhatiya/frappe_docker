...
app_include_css = ["/assets/express_tally/css/mobile_scroll_fix.css"]
app_include_js = ["/assets/express_tally/js/mobile_scroll_fix_v2.js"]
...
doctype_js = {"Customer": "public/js/customer_ledger.js"}
